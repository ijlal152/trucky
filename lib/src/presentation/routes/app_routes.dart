class AppRoutes {
  ...
  static const RouteSpec products = RouteSpec._(
    name: 'products',
    path: '/products',
  );
  static const RouteSpec addProduct = RouteSpec._(
    name: 'addProduct',
    path: '/products/add',
  );
  ...
  static const RouteSpec suppliers = RouteSpec._(
    name: 'suppliers',
    path: '/suppliers',
  );
  static const RouteSpec clients = RouteSpec._(
    name: 'clients',
    path: '/clients',
  );
  static const RouteSpec treasury = RouteSpec._(
    name: 'treasury',
    path: '/treasury',
  );
  static const RouteSpec analysis = RouteSpec._(
    name: 'analysis',
    path: '/analysis',
  );
